Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    resource :platform_settings, only: [ :edit, :update ], controller: "platform_settings"
  ...
  resources :bands, only: [ :index, :new, :create, :show, :edit, :update ] do
    ...
    resource :payments, only: [ :show ], controller: "band_payments" do
    ...
    resources :products, only: [ :index, :new, :create, :edit, :update, :destroy ] do
      ...
      resources :variants, controller: "product_variants", only: [ :new, :create, :edit, :update, :destroy ]
    end
