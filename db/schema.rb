...
ActiveRecord::Schema[8.1].define(version: 2026_09_26_130000) do
  ...
  create_table "community_replies", force: :cascade do |t|
    t.text "body", null: false
    t.bigint "community_topic_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["community_topic_id", "created_at"], name: "index_community_replies_on_community_topic_id_and_created_at"
    t.index ["community_topic_id"], name: "index_community_replies_on_community_topic_id"
    t.index ["user_id"], name: "index_community_replies_on_user_id"
    t.check_constraint "char_length(body) > 0", name: "community_replies_body_not_blank"
  end
  ...
  create_table "community_topics", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["band_id", "updated_at"], name: "index_community_topics_on_band_id_and_updated_at"
    t.index ["band_id"], name: "index_community_topics_on_band_id"
    t.index ["user_id"], name: "index_community_topics_on_user_id"
    t.check_constraint "char_length(body) > 0", name: "community_topics_body_not_blank"
    t.check_constraint "char_length(title::text) > 0", name: "community_topics_title_not_blank"
  end
  ...
  add_foreign_key "community_replies", "community_topics"
  add_foreign_key "community_replies", "users"
  add_foreign_key "community_topics", "bands"
